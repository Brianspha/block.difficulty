...
class GameState extends schema_1.Schema {
    // INIT
    constructor(mapName, maxPlayers, mode, onMessage) {
        super();
    ...
    playerAdd(id, name) {
        ...
        const player = new entities_1.Player(id, spawner.x + __1.Constants.PLAYER_SIZE / 2, spawner.y + __1.Constants.PLAYER_SIZE / 2, __1.Constants.PLAYER_SIZE / 2, 0, __1.Constants.PLAYER_MAX_LIVES, name || id);
